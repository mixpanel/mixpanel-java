...
public final class LocalFlagsConfig extends BaseFlagsConfig {
     ...
     */
    private LocalFlagsConfig(String apiHost, int requestTimeoutSeconds, boolean enablePolling, int pollingIntervalSeconds) {
        super(apiHost, requestTimeoutSeconds);
    ...
    public static final class Builder extends BaseFlagsConfig.Builder<Builder> {
        ...
        public LocalFlagsConfig build() {
            return new LocalFlagsConfig(apiHost, requestTimeoutSeconds, enablePolling, pollingIntervalSeconds);
        }
    }
